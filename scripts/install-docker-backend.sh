...
# Docker installation script for Backend VM
# This script will be executed during VM bootstrap

echo "Starting Docker installation on Backend VM..." > /var/log/docker-install.log
...
echo "Docker installation completed successfully on Backend VM at $(date)" >> /var/log/docker-install.log
